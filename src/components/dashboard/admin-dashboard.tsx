 ...
 * 관리자(admin) 대시보드 컴포넌트
 *
 * 학원 전체 통계 카드 5개 + 최근 기출문제 활동 리스트를 표시한다.
 * props로 AdminStats를 받아 순수 렌더링만 수행 (Server Component 호환).
 */
...
/** DashboardStats에서 admin 역할만 추출 */
type AdminStats = Extract<DashboardStats, { role: 'admin' }>
...
function getStatCards(stats: AdminStats): readonly StatCard[] {
  return [
    { title: '전체 사용자', value: stats.totalUsers },
    { title: '교사', value: stats.teacherCount },
    { title: '학생', value: stats.studentCount },
    { title: '기출문제', value: stats.pastExamCount },
    { title: '생성 문제', value: stats.questionCount },
  ]
}
